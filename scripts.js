...
var map = new mapboxgl.Map({
    ...
    center: [-74.0060, 40.7128], // CENTERED ON NEW YORK CITY
    zoom: 9.5,
    minZoom: 8.5
});
...
function addLayers() {
    map.addSource('newyorkFema', {
        type: 'geojson',
        data: 'data/NY_FEMA_County.geojson'
    });
...
function addCongressionalLayers() {
    map.addSource('nyCongress', {
        type: 'geojson',
        data: 'data/NY_Congress.geojson'
    });
...
function addHouseLayers() {
    map.addSource('nyHouse', {
        type: 'geojson',
        data: 'data/NY_House.geojson'
    });
...
function addSenateLayers() {
    map.addSource('nySenate', {
        type: 'geojson',
        data: 'data/NY_Senate.geojson'
    });
    ...
    return `
      <div style="color:#222; font-family:inherit;">
        ...
        <ul style="list-style:none; padding:0; margin:0 0 0.9em 0;">
          <li style="margin-bottom: 3px;"><strong>U.S. Senate:</strong> Chuck Schumer (D), Kristen Gillibrand (D)</li>
